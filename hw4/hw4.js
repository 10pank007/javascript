...
console.log(printArray(2, 3, 5, 7));
...
console.log(pharagraph("hello world"));
...
console.log(creatUlWithLi("hello world"));
...
console.log(creatUlWithLiAnotheOne("hello world"));
...
console.log(listFromArr(2, 3, "love", "dinamo"));
...
console.log(arrayOfObject({id: 1, name: "bohdan", age: 27}, {id: 2, name: "oleg", age: 25}));
...
console.log(swap([2, 5, 6, 8, 7, 9, 4], 1, 3));
